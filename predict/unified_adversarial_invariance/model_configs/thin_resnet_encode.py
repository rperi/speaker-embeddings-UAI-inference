...
# Based on thin resnet architecture in https://github.com/WeidiXie/VGG-Speaker-Recognition/blob/master/src/backbone.py
# (http://www.robots.ox.ac.uk/~vgg/publications/2019/Xie19a/xie19a.pdf)
...
def resnet_2D_v1(inputs, mode='train'):
    ...
    y = MaxPooling2D((3, 1), strides=(2, 4), name='mpool2')(x5)   # RP changed stride from original VGG code
